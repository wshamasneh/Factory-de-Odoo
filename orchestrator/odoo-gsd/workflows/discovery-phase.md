...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /odoo-gsd:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/odoo-gsd/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/odoo-gsd/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/odoo-gsd/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/odoo-gsd/templates/discovery.md
...
Use ~/.claude/odoo-gsd/templates/discovery.md.
...
1. Discuss phase context (/odoo-gsd:discuss-phase [current-phase])
2. Create phase plan (/odoo-gsd:plan-phase [current-phase])
