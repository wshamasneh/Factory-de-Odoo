...
- This section feeds directly into /odoo-gsd:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /odoo-gsd:plan-phase --gaps with root causes
...
**Creation:** When /odoo-gsd:verify-work starts new session
