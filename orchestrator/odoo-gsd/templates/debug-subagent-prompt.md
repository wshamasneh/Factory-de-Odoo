...
Template for spawning odoo-gsd-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="odoo-gsd-debugger", description="Debug UAT-001")
```
