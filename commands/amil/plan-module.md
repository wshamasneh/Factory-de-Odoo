...
**Requires:** Module at "planned" status with CONTEXT.md (from /amil:discuss-module)
...
**After this command:** Review spec.json, then run `/amil:generate-module {module}` to generate code.
</objective>
